        ...
        groups: {
            ...
            'Markup' : {
                htmlLangSet: {
                    ...
                    isActive: false,
                    test: dom => dom?.querySelector('html')?.getAttribute('lang') !== undefined
                },
            },
            'Content' : {
                onlyOneH1: {
            ...
            'Bilder' : {
                imageHasAlt: {
                    ...
                    isActive: false,
                    test: dom => Array
                        .from(dom?.querySelectorAll('img'))
                        .filter(img => img.getAttribute('alt') === undefined).length === 0
                }
            },
            'Formulare' : {
                inputLinkedToLabels: {
...
Array
    .from(Object.keys(a11yRuleset.groups))
    .forEach(group => flatA11yRuleset = {...flatA11yRuleset, ...a11yRuleset.groups[group]});
        ...
        Object
            ...
            .forEach(ruleId => {
                ...
                if (rule?.isActive) {
                    ...
                    rule.linked?.classList.add(ruleResult ? '--a11ySuccess' : '--a11yFailed');
                }
            });
    }
}
