...
<StoredCheckbox
  key="tabindex"
  label="Es gibt bei tabindex nur 0 oder -1"
/>
<StoredCheckbox
  key="a-tag"
...
<StoredCheckbox
  key="h1-per-page"
  label="Es gibt nur ein `&lt;h1 />` pro Seite"
/>
...
<StoredCheckbox
  key="inputs-labels"
  label="Alle Inputs sind mit einem entsprechenden Label verbunden"
/>
<StoredCheckbox
  key="form-input-autocomplete"
  label="Form-Inputs unterstützen grundsätzlich Autovervollständigung"
/>
<StoredCheckbox
  key="input-errors"
  label="Eingabefehler werden direkt mit den entsprechenden Feldern assoziiert"
/>
...
<StoredCheckbox
  key="viewport-zoom"
  label="Viewport Zoom ist deaktiviert"
/>
<StoredCheckbox
